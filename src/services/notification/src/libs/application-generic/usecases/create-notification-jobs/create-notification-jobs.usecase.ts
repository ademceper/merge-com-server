...
export class CreateNotificationJobs {
  ...
  private buildJobFromStep(step: NotificationStepEntity, command: CreateNotificationJobsCommand, notification: NotificationEntity): NotificationJob {
  ...
  ): IWorkflowStepMetadata | undefined {
