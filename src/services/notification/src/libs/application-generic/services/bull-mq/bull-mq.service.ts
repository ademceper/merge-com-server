...
export class BullMqService {
   ...
   *
   */
  private generatePrefix(prefix: JobTopicNameEnum): string | undefined {
  ...
  public async isQueuePaused(): Promise<boolean | undefined> {
    return await this._queue?.isPaused();
  }

  public async isWorkerPaused(): Promise<boolean | undefined> {
    return await this._worker?.isPaused();
  }

  public async isWorkerRunning(): Promise<boolean | undefined> {
