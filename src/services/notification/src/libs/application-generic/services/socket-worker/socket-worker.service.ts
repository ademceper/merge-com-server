...
import { ChannelTypeEnum, FeatureFlagsKeysEnum, WebSocketEventEnum } from 'libs/shared';
...
export class SocketWorkerService {
  ...
  private async sendUnreadCountChange(
    ...
    try {
      ...
      const counts: { total: number; severity: Record<string, number> } = {
        total: unreadCount,
        severity: {
          high: 0,
          medium: 0,
