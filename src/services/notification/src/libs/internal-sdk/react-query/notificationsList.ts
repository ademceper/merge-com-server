...
import { buildNotificationsListQuery, prefetchNotificationsList, queryKeyNotificationsList } from './notificationsList.core.js';
import type { NotificationsListQueryData } from './notificationsList.core.js';
export {
...
export function invalidateNotificationsList(
  ...
  return client.invalidateQueries({
    ...filters,
    queryKey: ['libs/internal-sdk', 'Notifications', 'list', ...queryKeyBase],
  });
}
...
export function invalidateAllNotificationsList(
  ...
  return client.invalidateQueries({
    ...filters,
    queryKey: ['libs/internal-sdk', 'Notifications', 'list'],
  });
}
