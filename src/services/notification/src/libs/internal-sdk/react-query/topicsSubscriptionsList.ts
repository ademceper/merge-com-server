...
import { buildTopicsSubscriptionsListQuery, prefetchTopicsSubscriptionsList, queryKeyTopicsSubscriptionsList } from './topicsSubscriptionsList.core.js';
import type { TopicsSubscriptionsListQueryData } from './topicsSubscriptionsList.core.js';
export {
...
export function invalidateTopicsSubscriptionsList(
  ...
  return client.invalidateQueries({
    ...filters,
    queryKey: ['libs/internal-sdk', 'Subscriptions', 'list', ...queryKeyBase],
  });
}
...
export function invalidateAllTopicsSubscriptionsList(
  ...
  return client.invalidateQueries({
    ...filters,
    queryKey: ['libs/internal-sdk', 'Subscriptions', 'list'],
  });
}
