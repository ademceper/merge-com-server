...
/** @internal */
const InAppStepResponseDtoControlValues$inboundSchema: z.ZodType<
...
function inAppStepResponseDtoControlValuesFromJSON(
  jsonString: string
...
function inAppStepResponseDtoFromJSON(
  jsonString: string
