...
/** @internal */
const CustomStepResponseDtoControlValues$inboundSchema: z.ZodType<
...
function customStepResponseDtoControlValuesFromJSON(
  jsonString: string,
...
function customStepResponseDtoFromJSON(
  jsonString: string,
