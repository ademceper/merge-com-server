...
import { CreateExecutionDetails, DetailEnum, FeatureFlagsService, PinoLogger } from 'libs/application-generic';
import { ControlValuesRepository, JobEntity, JobRepository } from 'libs/dal';
import { JSONContent as MailyJSONContent } from 'libs/maily-render';
import {
